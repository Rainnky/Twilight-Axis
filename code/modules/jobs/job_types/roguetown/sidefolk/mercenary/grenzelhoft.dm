...
/datum/advclass/mercenary/grenzelhoft/crossbowman
	...
	subclass_skills = list(
		...
		/datum/skill/labor/butchering = SKILL_LEVEL_JOURNEYMAN,		// meant to live off the land and set up camp.
...
/datum/advclass/mercenary/grenzelhoft/mage
	...
	subclass_mage_aspects = list("mastery" = FALSE, "major" = 1, "minor" = 2, "utilities" = 6, "locked_aspects" = list(/datum/magic_aspect/pyromancy), "variant" = "grenzelhoftian", "ward" = TRUE)
	subclass_stats = list(
		STATKEY_INT = 3,
		STATKEY_WIL = 3,
		STATKEY_STR = -1,
